 ...
 public:
  ...
  void SetUp() override {
    ...
    ks = std::make_shared<FileSystemKeyStore>(
        TEST_PATH, bls_provider_, secp256k1_provider_);
  }

 protected:
  static bool VectorContains(const std::vector<int> &vector, int value) {
